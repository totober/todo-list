...
function allTasks(e) {
    ...
    ;(0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.mainRender)(e)

    let projectsObj = _storage_js__WEBPACK_IMPORTED_MODULE_0__.storage.retrieveProjectsObj()

    projectsObj.forEach(project => {
        project.list.forEach(task => {
            ;(0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.taskElementCreator)(task.title, task.date, task.isChecked, task.isPriority)  
        })
    } )
}
...
function nextDays(e) {
    ...
    let todayDateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, "dd/MM/yyyy" )
    let plusWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todayDate, 7)
    let plusWeekFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(plusWeek, "dd/MM/yyyy")
    ...
    projectsObj.forEach(project => {
        project.list.forEach ((task) => {
            ...
            let taskDateParsed = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskDate, "dd/MM/yyyy", new Date())
            let taskDateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskDateParsed, "dd/MM/yyyy")
...
function month (e) {
    ...
    let todayDate = new Date()
    let thisMonthFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, "MM" )
    ...
    projectsObj.forEach(project => {
        project.list.forEach ((task) => {
            ...
            let taskDate = task.date
            let taskDateParsed = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskDate, "dd/MM/yyyy", new Date())
            let taskDateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskDateParsed, "MM")
...
/* harmony export */   taskElementCreator: () => (/* binding */ taskElementCreator)
/* harmony export */ });
...
function getTaskData (){
    ...
    let dateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date), "dd/MM/yyyy")
...
__webpack_require__(/*! ./aside.js */ "./src/aside.js")
...
function projectStorage (e) {
 ...
 function taskStorage(e) {
    ...
    let {title, dateFormat} = (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.getTaskData)()

    let task = new _to_do_js__WEBPACK_IMPORTED_MODULE_0__.Task(title, dateFormat)
